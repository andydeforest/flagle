<template>
  <BaseSection class="about-section" no-container>
    <h1>
      🚩About Flagle
    </h1>
    <p>
    ...
    <p>
      Questions? Comments? Concerns? Reach out to <a href="https://github.com/andydeforest" target="_blank">@andydeforest</a> on GitHub.
    </p>
  </BaseSection>
</template>
